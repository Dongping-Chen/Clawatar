...
box("PoleArm1", (2.5, -0.8, 2.9), (0.7, 0.03, 0.03), mat_dark_metal)
box("PoleArm2", (2.5, -0.8, 2.6), (0.5, 0.03, 0.03), mat_dark_metal)
# Wires
...
windows = [
    ...
    (-0.8, 2.09, 2.8, 0.1, 0.12), (0.3, 2.09, 2.5, 0.1, 0.12),
    (2.5, 2.09, 2.8, 0.12, 0.15), (3.3, -0.5, 1.5, 0.12, 0.15),
]
...
box("ConvSign", (0.6, 2.08, 2.8), (0.7, 0.04, 0.18), mat_conv_store)
# Bar/restaurant sign
box("BarSign", (1.8, 2.08, 2.0), (0.4, 0.03, 0.12), mat_sign_glow2)
# Additional neon signs
box("KaraokeSign", (-1.5, 2.08, 2.5), (0.35, 0.03, 0.1), mat_neon_pink)
box("DrugStoreSign", (3.0, 2.08, 3.5), (0.5, 0.03, 0.12), mat_neon_blue)
...
rbox("VendingMachine1", (1.5, 1.8, 0.45), (0.3, 0.25, 0.85), mat_vend, r=0.02)
box("VendLight1", (1.5, 1.55, 0.7), (0.25, 0.02, 0.2), mat_vend_glow)
# Red/orange vending machine
rbox("VendingMachine2", (1.15, 1.8, 0.45), (0.28, 0.25, 0.85), mat_vend2, r=0.02)
box("VendLight2", (1.15, 1.55, 0.7), (0.22, 0.02, 0.2), mat_vend_glow2)
...
vm_obj.location = (1.3, 1.5, 0.5)

# ─── GARBAGE BIN ───────────────────────────────────────────
cyl("GarbageBin", (-0.3, -0.7, 0.2), 0.08, 0.4, mat_garbage)
cyl("GarbageLid", (-0.3, -0.7, 0.42), 0.09, 0.03, mat_dark_metal)
...
box("NeonAccent1", (-2.19, -0.3, 2.2), (0.02, 0.4, 0.04), emit_mat("Neon1", (1.0, 0.2, 0.4, 1.0), 6.0))
box("NeonAccent2", (-2.19, 0.8, 1.8), (0.02, 0.3, 0.04), emit_mat("Neon2", (0.2, 0.5, 1.0, 1.0), 5.0))
box("NeonAccent3", (3.49, -0.5, 1.8), (0.02, 0.5, 0.04), emit_mat("Neon3", (1.0, 0.5, 0.1, 1.0), 5.0))
...
# ─── EXPORT GLB ────────────────────────────────────────────
glb_path = os.path.join(OUT, "phone-booth-v2.glb")
