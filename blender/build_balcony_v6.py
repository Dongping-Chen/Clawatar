...
m_floor_a = emit_mat("FloorA", (0.62, 0.46, 0.34, 1), 3.6)
m_floor_b = emit_mat("FloorB", (0.52, 0.38, 0.28, 1), 3.8)
m_wall = emit_mat("Wall", (0.94, 0.86, 0.76, 1), 3.2)
m_interior = emit_mat("Interior", (1.0, 0.86, 0.7, 1), 3.6)
m_window_frame = emit_mat("WindowFrame", (0.28, 0.22, 0.18, 1), 3.4)
m_window_glow = emit_mat("WindowGlow", (1.0, 0.8, 0.55, 1), 10.0)
m_door_glow = emit_mat("DoorGlow", (1.0, 0.78, 0.5, 1), 10.0)

m_railing = emit_mat("Railing", (0.92, 0.88, 0.82, 1), 4.0)
m_railing_cap = emit_mat("RailingCap", (0.98, 0.95, 0.9, 1), 4.6)

m_table = emit_mat("Table", (0.25, 0.2, 0.22, 1), 4.4)
m_chair = emit_mat("Chair", (0.25, 0.2, 0.22, 1), 4.2)
m_seat = emit_mat("Seat", (0.86, 0.5, 0.28, 1), 4.6)

m_pot = emit_mat("Pot", (0.7, 0.36, 0.2, 1), 4.2)
m_soil = emit_mat("Soil", (0.2, 0.12, 0.08, 1), 3.2)
m_leaf1 = emit_mat("Leaf1", (0.2, 0.56, 0.22, 1), 3.6)
m_leaf2 = emit_mat("Leaf2", (0.12, 0.46, 0.16, 1), 3.6)

m_building = emit_mat("Building", (0.08, 0.08, 0.12, 1), 3.2)
m_win = emit_mat("WindowLight", (1.0, 0.8, 0.45, 1), 10.0)

m_bulb = emit_mat("Bulb", (1.0, 0.88, 0.6, 1), 16.0)
m_moon = emit_mat("Moon", (1.0, 1.0, 1.0, 1), 20.0)
m_star = emit_mat("Star", (1.0, 1.0, 1.0, 1), 10.0)

m_plate = emit_mat("Plate", (0.95, 0.92, 0.88, 1), 3.4)
m_book = emit_mat("Book", (0.3, 0.15, 0.1, 1), 3.8)
m_wine = emit_mat("Wine", (0.62, 0.12, 0.2, 1), 4.8)
...
box("InteriorGlow", (0, -2.8, 1.2), (2.0, 0.02, 1.2), emit_mat("InteriorGlowMat", (1.0, 0.84, 0.58, 1), 7.0))
sphere("InteriorLamp", (0.6, -2.7, 2.1), 0.12, emit_mat("InteriorLampMat", (1.0, 0.86, 0.64, 1), 14.0))
